...
function formatDirections(gdir, mode) {
	...
	retStr += "\t<tr class='heading'><td class='heading' width=40>"
	    + "<div class='centered-directions'><img src='BlackDot.png'></div></td>"
	...
	dragStr += "<li id='" + i + "' class='ui-state-"
	  + (i ? "default" : "disabled") + "'>"
	  + "<table class='dragTable'><tr><td class='left'><img src='BlackDot.png' /></td><td class='middle'>" + headerStr + "</td><td class='right'>"
	...
	dragStr += "<li id='" + 0 + "' class='ui-state-disabled'>"
	  + "<table class='dragTable'><tr><td><img src='BlackDot.png' /></td><td>" + headerStr
	  + "</td></tr></table></li>";
	...
	dragStr += "<li id='" + gdir.legs.length + "' class='ui-state-disabled'>"
	  + "<table class='dragTable'><tr><td><img src='BlackDot.png' /></td><td>"
...
function drawMarker(latlng, addr, label, num) {
    var icon;
    icon = new google.maps.MarkerImage("RedDot.png");
...
function onSolveCallback(myTsp) {
  jQuery('#dialogProgress').dialog('close');
	...
	var myIcn1 = new google.maps.MarkerImage("BlackDot.png");
	var marker = new google.maps.Marker({
            position: myPt1,
	    icon: myIcn1,
	    map: gebMap });
	...
	if (i == dir.legs.length - 1 && mode == 0) {
	    myIcn1 = new google.maps.MarkerImage("BlackDot.png");
	} else {
	    myIcn1 = new google.maps.MarkerImage("BlackDot.png");
	}
	var marker = new google.maps.Marker({
